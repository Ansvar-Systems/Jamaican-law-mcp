...
**Endpoint:** `https://mcp.ansvar.eu/law-jm/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add jamaican-law --transport http https://mcp.ansvar.eu/law-jm/mcp` |
...
```json
{
  "mcpServers": {
    "jamaican-law": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/law-jm/mcp"
    }
  }
}
```
